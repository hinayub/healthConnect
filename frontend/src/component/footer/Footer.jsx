          ...
          <div className="flex gap-10 w-full">
            <div className="flex flex-col w-2/5">
              ...
              <span className="text-text-white text-base">
                A digital healthcare platform connecting qualified doctors and
                therapists with patients for home visits, clinical
                consultations, and online video appointments in one secure and
                convenient place
              </span>
            </div>
            <div className="w-1/5">
              <h2 class="mb-6 text-sm font-semibold text-heading  text-text-white">
                For Patient
              </h2>
              <ul class="text-body text-sm">
                <ListElement text="Find Doctor" />
                <ListElement text="Book Appointment" />
                <ListElement text="Video Consultation" />
              </ul>
            </div>
            <div>
              <h2 class="mb-6 text-sm font-semibold text-heading  text-text-white">
            ...
            <div>
              ...
              <ul class="text-body font-medium">
                ...
                <li class="mb-4">
                  <li data-fg-ddgv176="4.11:189.150:/components/Home.tsx:255:17:10953:26:e:li">
                    +1 (555) 000-0000
                  </li>
                </li>
              </ul>
              <div>
                ...
                <div>
                  <IoLogoInstagram className="text-text-white" size={30} />
                  <BsWhatsapp className="text-text-white" size={25} />
                  <FaFacebookF className="text-text-white" size={25} />
                </div>
              </div>
            </div>
          </div>
